...
import { Container, Paper, Typography, Table, TableBody, TableRow, TableCell, Checkbox, Box, Button } from "@mui/material";
...
export const Tasks = ({ title = "Tasks", filter = () => true }) => {
  ...
  const { data } = api.endpoints.getTasks.useQuery(undefined, { pollingInterval: 60000 });
