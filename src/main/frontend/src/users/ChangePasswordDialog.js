...
export const ChangePasswordDialog = () => {
  const { values, invalid, isValid, error, setError, clearForm, onChange }
    = useForm({ initialValue: { currentPassword: "", newPassword: "" } });
    ...
    <Dialog open={changePasswordOpen} onClose={close}>
      ...
      <DialogContent>
        ...
        <TextField type='password' fullWidth margin='dense' variant='standard' label="Current Password"
          ...
          required error={Boolean(invalid.currentPassword)} autoFocus
        />
        <TextField type='password' fullWidth margin='dense' variant='standard' label="New password"
          name='newPassword' value={values.newPassword} onChange={onChange} required
